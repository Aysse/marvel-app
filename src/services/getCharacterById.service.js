...
export default async function getCharacterByIdService({ baseUrl, id, params = null }) {
    ...
    return formatCharacters({ data: character, isMultiple: false, comics: formattedComics });
}
